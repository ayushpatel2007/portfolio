...
const STORY_MILESTONES = [
    { id: 'intro', position: [0, 0, -15], type: 'intro', title: 'AYUSH PATEL', subtitle: '< automation & robotics engineering student />' },
    { id: 'awards', position: [0, 0, -55], type: 'awards', title: 'PROJECTS & HACKATHONS', subtitle: '10+ Projects • 4 Hackathons • 15+ Events Coordinated' },
    { id: 'journey', position: [0, 0, -95], type: 'journey', title: 'PARUL UNIVERSITY', subtitle: 'Diploma in Automation and Robotics' },
    { id: 'skills', position: [0, 0, -135], type: 'skills', title: 'SKILLS & TECH STACK', subtitle: 'Python • React • Next.js • Arduino • ESP32 • LiDAR • OpenCV' },
];
