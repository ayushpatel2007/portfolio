...
const AWARDS_DATA = {
    featured: {
        ...
        items: [
            { label: 'Introduction To Generative AI (Google Cloud Skills Boost)', date: '', image: '/textures/about/FEATURED.webp', url: 'https://cloud.google.com' },
            { label: 'Bring AI To Work Workshop (Google Workspace)', date: '', image: '/textures/about/FEATURED.webp', url: 'https://workspace.google.com' },
        ],
        platformConfig: {
            label: 'CERTIFICATE',
            color: '#1a1a1a',
...
const BALLOON_CONFIG = [
    // Large balloons (main robotics & hardware skills)
    { texture: '/textures/about/reactduzybalon.webp', paintedTexture: '/textures/about/reactduzybalon_painted.webp', label: 'Arduino', size: 'large', x: -2.5, y: 2, z: 0.3, phase: 0 },
    { texture: '/textures/about/threejsduzybalon.webp', paintedTexture: '/textures/about/threejsduzybalon_painted.webp', label: 'ESP32', size: 'large', x: 2.5, y: 2.5, z: 0.2, phase: 1.5 },
    { texture: '/textures/about/GSAPduzybalon.webp', paintedTexture: '/textures/about/GSAPduzybalon_painted.webp', label: 'Raspberry Pi', size: 'large', x: 0, y: 3, z: 0.5, phase: 3 },

    // Medium balloons - sensors & engineering software
    { texture: '/textures/about/JSSREDNIBALON.webp', paintedTexture: '/textures/about/JSSREDNIBALON_painted.webp', label: 'LiDAR SLAM', size: 'medium', x: -4, y: 1, z: -0.3, phase: 0.8 },
    { texture: '/textures/about/csssrednibalon.webp', paintedTexture: '/textures/about/csssrednibalon_painted.webp', label: 'OpenCV', size: 'medium', x: 4, y: 1.5, z: -0.2, phase: 2.2 },
    { texture: '/textures/about/nextjssrednibalon.webp', paintedTexture: '/textures/about/nextjssrednibalon_painted.webp', label: 'Fusion 360', size: 'medium', x: 0, y: 0.5, z: -0.4, phase: 4 },

    // Small balloons - languages & tools
    { texture: '/textures/about/htmlmalybalon.webp', paintedTexture: '/textures/about/htmlmalybalon_painted.webp', label: 'Sensors', size: 'small', x: -5.5, y: 2.5, z: -0.8, phase: 1.2 },
    { texture: '/textures/about/gitmalybalon.webp', paintedTexture: '/textures/about/gitmalybalon_painted.webp', label: 'Python', size: 'small', x: 5.5, y: 3, z: -0.7, phase: 2.8 },
    { texture: '/textures/about/figmamalybalon.webp', paintedTexture: '/textures/about/figmamalybalon_painted.webp', label: 'Prompt Eng', size: 'small', x: -3, y: 4.5, z: -0.5, phase: 3.5 },
    { texture: '/textures/about/firebasemalybalon.webp', paintedTexture: '/textures/about/firebasemalybalon_painted.webp', label: 'Next.js / React', size: 'small', x: 3.5, y: 4, z: -0.6, phase: 4.5 },
];
