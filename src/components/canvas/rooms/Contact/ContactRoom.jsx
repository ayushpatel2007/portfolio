...
const ContactRoom = ({ showRoom, onReady, isExiting, isWarmup }) => {
    ...
    const handleMailSelect = () => {
        window.location.href = 'mailto:patelayush20@outlook.com';
    };
        ...
        <group ref={groupRef} position={[0, -0.7, -5]}>
            ...
            <SocialBarrel
                ...
                onClick={() => {
                    ...
                    window.open('https://www.linkedin.com/in/ayushpatel2037/', '_blank');
                }}
            ...
            <SocialBarrel
                ...
                onClick={() => {
                    unlockAchievement('contact_choose');
                    unlockAchievement('contact_submit');
                    window.open('https://github.com/ayushpatel2007', '_blank');
                }}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
            ...
            <SocialBarrel
                ...
                onClick={() => {
                    unlockAchievement('contact_choose');
                    unlockAchievement('contact_submit');
                    window.open('/assets/Ayush_Patel_resume.pdf', '_blank');
                }}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
