...
const FALLBACK_PROJECTS = [
    {
        id: 'ai-autonomous-driving-robot',
        ...
        description: 'Raspberry Pi 5 autonomous robot integrating LiDAR, SIM800L, and GPS. Built using OpenCV with Python GUI for coding and Google AI Studio for LiDAR distance mapping and real-time sensor telemetry.',
    ...
    {
        id: 'hand-gesture-controlled-car',
        title: 'HAND GESTURE ROBOT CAR',
        front: '/textures/gallery/timberkittyprzod.webp',
        painted: '/textures/gallery/timberkittyprzod_painted.webp',
        url: 'https://github.com/ayushpatel2007',
        description: 'Surveillance robot car for hazardous environments controlled via hand gestures. Uses Arduino UNO R3, MPU6050, HC-12 wireless module, L298N drivers, and ESP32-CAM for IP-based live video streaming.',
        techStack: ['/textures/gallery/jslogo.webp', '/textures/gallery/htmllogo.webp', '/textures/gallery/csslogo.webp', '/textures/gallery/reactlogo.webp']
    },
    {
    ...
    {
        id: 'mapping-robot-car',
        title: 'MAPPING ROBOT CAR',
        front: '/textures/gallery/bioprzod.webp',
        painted: '/textures/gallery/bioprzod_painted.webp',
        url: 'https://github.com/ayushpatel2007',
        description: 'Autonomous mapping robot using ESP32, LiDAR, MPU6050, and HC-SR04 sensors. Detects walls, measures room boundaries, and transmits live 2D mapping data to an interactive HTML web interface.',
        techStack: ['/textures/gallery/jslogo.webp', '/textures/gallery/htmllogo.webp', '/textures/gallery/csslogo.webp', '/textures/gallery/reactlogo.webp']
    },
    {
        id: 'stretch-wrapping-robot',
        title: 'STRETCH WRAPPING ROBOT',
        front: '/textures/gallery/monetuneprzod.webp',
        painted: '/textures/gallery/monetuneprzod_painted.webp',
        url: 'https://github.com/ayushpatel2007',
        description: 'Automated industrial stretch wrapping robot constructed with Arduino UNO R3, NEMA-17 steppers, CNC Shield, A4988 drivers, 4040 aluminum extrusion, 2020 V-Wheel gantry plate, and SMPS power distribution.',
        techStack: ['/textures/gallery/jslogo.webp', '/textures/gallery/htmllogo.webp', '/textures/gallery/csslogo.webp', '/textures/gallery/reactlogo.webp']
    },
    {
        id: 'finnexa-ai',
        ...
        description: 'Intelligent financial advisory platform built with Next.js, React, Supabase, and OpenRouter API key. Features instant AI document analysis, SIP projections, EMI calculations, and database-backed chat history.',
    ...
    },
    {
        ...
        description: 'Browser-based push-to-talk voice channel app built with WebRTC, Socket.IO, Express, and Node.js. Features encrypted channels, emergency SOS alerts, and live participant lists.',
        techStack: ['/textures/gallery/jslogo.webp', '/textures/gallery/htmllogo.webp', '/textures/gallery/csslogo.webp', '/textures/gallery/netlifylogo.webp']
    },
];
